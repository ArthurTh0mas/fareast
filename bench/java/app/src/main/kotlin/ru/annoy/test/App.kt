...
import com.github.ng8eke.Fareast.*
...
fun main(args: Array<String>) {
    ...
    for (metric in arrayOf("angular", "euclidean")) {
        ...
        println()
        val index2 = ANNIndex(dim, path, com.spotify.annoy.IndexType.valueOf(metric.toUpperCase()))
...
fun testSpeed1(index: IAnnoyIndex, metric: String, nLoop: Long, nResult: Int, size: Int) {
    ...
    println("[Java]com.github.ng8eke:Fareast")
